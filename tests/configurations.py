configurations = [
    ...
    ('gold + passivize + semrestr', ['--semantic-restrictions', '--passivize'], (78.34, 70.99)),
    ...
    ('argid + passive + semrestr', ['--argument-identification', '--passivize', '--semantic-restrictions'], (45.07, 36.95)),
