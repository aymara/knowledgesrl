...
class FrameMatcherTest(unittest.TestCase):
    def test_1(self):
        ...
        frame2 = VerbnetOfficialFrame(
            [{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Patient'}, {'elem': 'for'}, {'elem': 'NP', 'role': 'Role1'}], 'a', [])
        frame3 = VerbnetOfficialFrame(
            [{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Patient'}, {'elem': 'with'}, {'elem': 'NP', 'role': 'Role2'}], 'b', [])
        frame4 = VerbnetOfficialFrame(
            [{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Patient'}, {'elem': 'with'}, {'elem': 'NP', 'role': 'Role3'}], 'c', [])
    ...
    def test_4(self):
        ...
        matcher = FrameMatcher(frame_occurrence, 'sync_predicates')
        verbnet_frames = [
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Theme'}], 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Theme'}], 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Theme'}, {'elem': 'V'}], 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Theme'}], 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Theme'}, {'elem': 'V'}, {'elem': 'with'}, {'elem': 'NP', 'role': 'Instrument'}],
                                 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Theme'}, {'elem': 'with'}, {'elem': 'NP', 'role': 'Instrument'}],
                                 'XX', []),
            VerbnetOfficialFrame([{'elem': 'NP', 'role': 'Instrument'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'Theme'}], 'XX', [])
        ]
    ...
    def test_baseline_alg(self):
        ...
        verbnet_frames = [
            VerbnetOfficialFrame(
                [{'elem': 'NP', 'role': 'R1'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'R2'}, {'elem': 'by'}, {'elem': 'NP', 'role': 'R3'}],
                'XX', []),
            VerbnetOfficialFrame(
                [{'elem': 'NP', 'role': 'R1'}, {'elem': 'V'}, {'elem': 'NP', 'role': 'R4'}, {'elem': {'for', 'as'}}, {'elem': 'NP', 'role': 'R5'}],
                'XX', [])
        ]
    ...
    def test_removed_that(self):
        ...
        best_score = matcher.perform_frame_matching([VerbnetOfficialFrame(
            [{'elem': 'NP', 'role': 'Agent'}, {'elem': 'V'}, {'elem': 'that'}, {'elem': 'S', 'role': 'Patient'}],
            'consider-29.9-1', [])])
        self.assertEqual(best_score, 200)
